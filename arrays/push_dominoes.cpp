//concept is that we simply check for left to right falling dominoes and after howm much time it will affect left to right ,|||ly we check for right to left and then traverse finally and check for whose values is less means that will affect the . domino first.
class Solution {
public:
